...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Wojciech Kania"
    user-mail-address "wojtek@kania.sh")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/wojtek/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/wojtek/bin" "/profile/bin" "/Users/wojtek/.npm-packages/bin" "/Users/wojtek/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
